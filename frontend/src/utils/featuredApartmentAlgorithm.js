...
export function calculateFullCoordinates(latitude, longitude, distanceInMiles) {
    ...
    const newLatitude = radiansToDegrees(newLatitudeInRadians);
    ...
    const newLongitude = radiansToDegrees(newLongitudeInRadians);

    return {
        latitude_start: latitude,
        longitude_start: longitude,
        latitude_end: newLatitude,
        longitude_end: newLongitude
    };
}
