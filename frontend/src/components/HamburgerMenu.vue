    ...
    <div id="sidemenu">
        ...
        <nav v-show="navOpen">
            ...
            <ul class="sidemenu__list">
                ...
                <li class="sidemenu__item" @click.prevent="navigateAndClose('#home')"><a href="">Renter Tools (N/A)</a></li>
                <li class="sidemenu__item" @click.prevent="navigateAndClose('#home')"><a href="">Lessor Tools (N/A)</a></li>
            </ul>
            </div>
        </nav>
        </transition>
